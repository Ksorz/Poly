/* Дан угол часовой стрелки h_angle= [0, 360). Значение вещественного типа.

Напишите программу используя математические операции для вычисления угла минутной стрелки на циферблате часов.

Введите ответы для следующих входных данных (при необходимости ответ округлить до 2 знаков справа от запятой): */
