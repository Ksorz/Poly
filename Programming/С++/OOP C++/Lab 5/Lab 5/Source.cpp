...
string ElectricalWire::className = "Питание от провода";
...
int main()
{
	...
	// Инициализируем базовый спсок предметов
	...
	iss[10] = new ElectricalWire{ "Паяльник", 18, "Пояй over 9000", 1000, 220, 2.5 };
	iss[11] = new ElectricalWire{ "Дрель", 6 };
	iss[12] = new ElectricalWire{ "Строительный фен", 4, "Птеродактиль", 7999 };
